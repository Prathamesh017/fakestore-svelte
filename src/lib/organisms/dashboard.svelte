...
<div class="dashboard w-full flex mt-2 p-4">
  <div class="category-container-left w-1/5">
  ...
  <div class="category-container-right grow">
     <div class="flex justify-end mr-4">
      ...
      <div class="flex justify-center">
        <CardContainer  selectedCategories={ selectedCategories} data={data} selected={selected} searchText={searchText}></CardContainer>
   </div> 
  </div>
</div>